...
@constraint(ESM, StorageEnergyCapacityFunction[s in storages, f in fuels; StorageDisChargeEfficiency[s,f]>0], sum(StorageEnergyCapacity[s,f]) <= MaxStorageCapacity[s])
